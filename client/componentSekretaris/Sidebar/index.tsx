...
export default function Sidebar({
  ...
  const clickInputRenaksi = () => {
    router.push("/Sekretaris/InputRenaksi");
  };
  ...
  const clickUbahJadwal = () => {
    router.push("/Sekretaris/UbahJadwalRenaksi");
  };

  const clickEvaluasiLampiran = () => {
    router.push("/Sekretaris/EvaluasiLampiran");
  };

  const clickHapusRenaksi = () => {
    router.push("/Sekretaris/HapusRenaksi");
  };
  const clickRiwayatKegiatan = () => {
    router.push("/Sekretaris/RiwayatKegiatanSubid");
  };

  const clickProfil = () => {
    router.push("/Sekretaris/Profil");
  };

  const clickNotif = () => {
    router.push("/Sekretaris/Notifikasi");
  };
  // const clickLogOut = () => {
