...
export default function Sidebar({
  ...
  const clickDaftarKegiatan = () => {
    router.push("/Kasubag/DaftarKegiatan");
  };

  const clickInputRenaksi = () => {
    router.push("/Kasubag/InputRenaksi");
  };
  ...
  const clickUbahJadwal = () => {
    router.push("/Kasubag/UbahJadwalRenaksi");
  };

  const clickEvaluasiLampiran = () => {
    router.push("/Kasubag/EvaluasiLampiran");
  };

  const clickHapusRenaksi = () => {
    router.push("/Kasubag/HapusRenaksi");
  };
  const clickRiwayatKegiatan = () => {
    router.push("/Kasubag/RiwayatKegiatan");
  };

  const clickProfil = () => {
    router.push("/Kasubag/Profil");
  };

  // const clickNotif = () => {
  //   router.push("/Kasubag/Notifikasi");
  // };
  // const clickLogOut = () => {
