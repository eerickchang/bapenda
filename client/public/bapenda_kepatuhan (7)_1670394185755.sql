...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2022 at 02:17 PM
...
(470, '2022-12-01', 0, 19, 4, 15, 141, 0),
...
(484, '2022-12-01', 0, 21, 3, 18, 1411, 0),
...
(555, '2022-12-01', 0, 22, 4, 18, 12345, 0),
...
(6152, 'Memukul Sapi', 'Memukul Sapi', 'Memukul Sapi', 'Memukul Sapi', 123, 'Labeling', 0, 'Menunggu Renaksi Diterima', '2022-01-01', '2022-05-01', '', 'So bangka bangka tu sapi', '', 'Katedu', NULL, NULL, 'Admin', ''),
(6153, 'Menggoreng Telur', 'Menggoreng Telur', 'Menggoreng Telur', 'Menggoreng Telur', 123, 'Labeling', 0, 'Menunggu Renaksi Diterima', '2022-01-01', '2022-12-01', '', 'So gosong tu telor', '', 'Katedu', NULL, NULL, 'Admin', ''),
(6154, 'Latihan Tinju', 'Latihan Tinju', 'Latihan Tinju', 'Latihan Tinju', 123, 'See Samrat', 0, 'Menunggu Renaksi Diterima', '2022-05-01', '2022-05-01', 'IMG-20220420-WA0025_1665486033422.jpg', 'So cape latihan tinju', '', 'Katedu', '2022-05-01', '2022-12-01', 'Admin', ''),
(6155, 'Makan Pisang Goreng', 'Makan Pisang Goreng', 'Makan Pisang Goreng', 'Makan Pisang Goreng', 123, 'Labeling', 0, 'Menunggu Renaksi Dihapus', '2022-01-01', '2022-12-01', 'IMG-20220222-WA0039_1665459380526.jpg', 'So klar makan pisang noh', 'Katedu ngna', '', NULL, NULL, 'Staff', 'Kasubid'),
(6156, 'Main Bola', 'Main Bola', 'Main Bola', 'Main Bola', 123, 'Labeling', 70123, 'Menunggu Renaksi Dihapus', '2022-01-01', '2022-12-01', 'IMG-20220513-WA0058_1665485263868.jpg', 'Deng kt bingo kyp kt mo ajukan hapus', 'katedu', '', NULL, NULL, 'Staff', ''),
...
(6158, 'Membawa Anak ke Rumah Sakit', 'Membawa Anak ke Rumah Sakit', 'Membawa Anak ke Rumah Sakit', 'Membawa Anak ke Rumah Sakit', 123, '', 80129, 'Menunggu Jadwal Diubah', '2022-06-01', '2022-12-01', 'IMG-20220410-WA0040_1665484756636.jpeg', 'Blum ada dokter', 'Admin - nda jelas', '', '2022-06-01', '2022-11-01', 'Staff', ''),
(6159, 'Memasak Abon', 'Memasak Abon', 'Memasak Abon', 'Memasak Abon', 123, '', 0, 'Sementara', '2022-01-01', '2022-12-01', '', '', '', '', NULL, NULL, '', ''),
(6160, 'Menggoreng Sapi', 'Menggoreng Sapi', 'Menggoreng Sapi', 'Menggoreng Sapi', 123, '', 70123, 'Selesai', '2022-06-01', '2022-12-01', 'IMG-20220420-WA0025_1665484623552.jpg', 'So klar goreng napa riki so gosong', '', '', NULL, NULL, '', ''),
...
(6166, 'Mengecas Hp', 'Mengecas Hp', 'Mengecas Hp', 'Mengecas Hp', 1, 'Labeling', 80129, 'Menunggu Jadwal Diubah', '2022-01-01', '2022-12-01', '', 'Hp ilang', '', '', NULL, NULL, 'Admin', ''),
...
(6175, 'Minum Kopi Kenangan Mantan', 'Minum Kopi Kenangan Mantan', 'Minum Kopi Kenangan Mantan', 'Minum Kopi Kenangan Mantan', 123, '', 70123, 'Menunggu Renaksi Diterima', '2022-10-01', '2022-12-01', '', '', '', '', NULL, NULL, 'Admin', ''),
...
(6190, 'Kasubid Punya', 'Kasubid Punya', 'Kasubid Punya', 'Kasubid Punya', 141, 'Labeling', 0, 'Menunggu Renaksi Dihapus', '2022-07-01', '2022-12-01', '', '', '', '', NULL, NULL, 'Kaban', ''),
(6191, 'Tes', '', 'Kasubid Punya', 'Kasubid Punya', 141, 'Labelling', 0, 'Menunggu Renaksi Diterima', '2022-12-14', '2022-12-24', '', '', '', '', NULL, NULL, 'Kaban', ''),
...
('Ferren Kalalo', 12345, '', '', 'Kepala Badan', '12345', '$2b$10$lqxj73QnOgpPtAAsTQlL9OZi0JuJ6rD2PX4CVDdhKyUVtABihLFo6', ''),
...
INSERT INTO `riwayat_kegiatan` (`id_riwayat`, `id_renaksi`, `nip`, `status`, `kondisi`) VALUES
(1, 6141, 8800, 'Ubah Jadwal', 'Diterima'),
(2, 227, 123, 'Ubah Jadwal', 'Diterima'),
(3, 226, 123, 'Ubah Jadwal', 'Diterima'),
(4, 226, 123, 'Ubah Jadwal', 'Diterima'),
(5, 226, 123, 'Ubah Jadwal', 'Ditolak'),
(6, 6137, 8800, 'Hapus Kegiatan', 'Diterima'),
(7, 221, 123, 'Hapus Kegiatan', 'Diterima'),
(8, 6135, 123, 'Hapus Kegiatan', 'Diterima'),
(9, 6135, 123, 'Hapus Kegiatan', 'Ditolak'),
(10, 225, 123, 'Ubah Jadwal', 'Ditolak'),
(11, 211, 123, 'Mengirim Renaksi', 'Ditolak'),
(12, 222, 123, 'Mengirim Renaksi', 'Ditolak'),
(13, 6142, 8800, 'Unggah Lampiran', 'Diterima'),
(14, 6142, 8800, 'Unggah Lampiran', 'Diterima'),
(15, 6142, 8800, 'Unggah Lampiran', 'Ditolak'),
(16, 6154, 123, 'Ubah Jadwal', 'Diterima'),
(17, 6155, 123, 'Unggah Lampiran', 'Diterima'),
(18, 6153, 123, 'Hapus Kegiatan', 'Diterima'),
(19, 6183, 22, 'Mengirim Renaksi', 'Ditolak'),
(20, 6171, 11, 'Ubah Jadwal', 'Ditolak'),
(21, 6158, 123, 'Ubah Jadwal', 'Diterima'),
(22, 6154, 123, 'Ubah Jadwal', 'Diterima'),
(23, 6172, 11, 'Unggah Lampiran', 'Ditolak'),
(24, 6168, 1, 'Unggah Lampiran', 'Ditolak'),
(25, 6152, 123, 'Unggah Lampiran', 'Diterima'),
(26, 6156, 123, 'Hapus Kegiatan', 'Ditolak'),
(27, 6153, 123, 'Hapus Kegiatan', 'Diterima'),
(28, 6160, 123, 'Unggah Lampiran', 'Diterima'),
(29, 6189, 123, 'Mengirim Renaksi', 'Ditolak'),
(30, 6189, 123, 'Mengirim Renaksi', 'Ditolak'),
(31, 6158, 123, 'Ubah Jadwal', 'Ditolak');
...
--
ALTER TABLE `cakin`
  MODIFY `id_cakin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=629;
...
--
ALTER TABLE `riwayat_kegiatan`
  MODIFY `id_riwayat` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
